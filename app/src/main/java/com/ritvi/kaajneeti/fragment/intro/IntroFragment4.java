...
public class IntroFragment4 extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.frag_intro_4,container,false);
    ...
    public void onViewStateRestored(@Nullable Bundle savedInstanceState) {
        ...
        ll_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getActivity(),EnterMobileNumberActivity.class).putExtra("type", Constants.ENTER_MOBILE_REGISTRATION_TYPE));
