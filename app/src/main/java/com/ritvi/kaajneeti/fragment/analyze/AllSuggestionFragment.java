...
public class AllSuggestionFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.frag_all_suggestion,container,false);
    ...
    List<FeedPOJO> suggestionPOJOS = new ArrayList<>();
    HomeFeedAdapter suggestionAnalyzeAdapter;

    public void attachAdapter() {

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        rv_data.setLayoutManager(linearLayoutManager);
        suggestionAnalyzeAdapter = new HomeFeedAdapter(rv_data,getActivity(), this, suggestionPOJOS, getChildFragmentManager());
        rv_data.setHasFixedSize(true);
        rv_data.setAdapter(suggestionAnalyzeAdapter);
