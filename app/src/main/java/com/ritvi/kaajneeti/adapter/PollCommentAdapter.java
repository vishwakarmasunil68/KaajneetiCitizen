...
public class PollCommentAdapter extends RecyclerView.Adapter<PollCommentAdapter.ViewHolder> {
    private List<PollCommentPOJO> items;
    Activity activity;
    Fragment fragment;

    public PollCommentAdapter(Activity activity, Fragment fragment, List<PollCommentPOJO> items) {
        this.items = items;
